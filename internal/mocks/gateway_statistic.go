...
// GatewayStatistic is an autogenerated mock type for the GatewayStatistic type
type GatewayStatistic struct {
	mock.Mock
}

// FindStatistic provides a mock function with given fields: ctx, slotID, groupID
func (_m *GatewayStatistic) FindStatistic(ctx context.Context, slotID int64, groupID int64) ([]model.Statistic, error) {
...
func (_m *GatewayStatistic) IncrementClicks(ctx context.Context, bannerID int64, slotID int64, groupID int64) error {
...
func (_m *GatewayStatistic) IncrementShows(ctx context.Context, bannerID int64, slotID int64, groupID int64) error {
	ret := _m.Called(ctx, bannerID, slotID, groupID)
